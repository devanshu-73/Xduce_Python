...
-- (1)stored Procedure for creating table and inserting data
...
-- (2) Variable Stored Procedure

create procedure variableprocedure
as
begin
	declare @records int=0;
	select @records = COUNT(*) from DBO.student_details;
	select @records;
end;

exec variableprocedure;

drop procedure variableprocedure;